...
export type MissionRow = {
	id: number;
	// Opaque 8-char base62 slug for URL addressing (/missions/:external_id).
	// Generated by src/lib/short-id.ts; createMission retries on UNIQUE
	// collision. The INTEGER `id` stays as the FK authority for
	// participants/polls/etc.; callers should resolve external_id → id at
	// the route boundary and use the integer id internally.
	external_id: string;
	template_id: string;
	callsign: string;
	seq: number;
