...
CREATE TABLE missions (
    id              INTEGER PRIMARY KEY AUTOINCREMENT,
    -- Opaque 8-char base62 slug for URL routing (/missions/:external_id).
    -- Generated by app code (src/lib/short-id.ts) with retry-on-collision.
    -- The INTEGER PK remains the FK authority for participants/polls/etc.
    external_id     TEXT,
